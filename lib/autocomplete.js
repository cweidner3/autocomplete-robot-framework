...
var getImports = function(currentResourceKey){
  ...
  if(currentResource){
    ...
    for(const importedLibrary of importedLibraries){
      const resourceKey = importedLibrary.physical && importedLibrary.absolutePath
        ? common.getResourceKey(importedLibrary.absolutePath) : common.getResourceKey(importedLibrary.name)
