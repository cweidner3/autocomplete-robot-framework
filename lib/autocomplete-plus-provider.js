...
var provider = {
  ...
  load() {
    ...
    atom.commands.add('atom-text-editor', 'Robot Framework:Print autocomplete debug info (current file)', () =>  {
      editor = atom.workspace.getActiveTextEditor()
      if(editor){
        provider.printDebugInfo(common.getResourceKey(editor.getPath()))
        atom.notifications.addSuccess('Debug info printed in Developer Tools console')
      }
    })
